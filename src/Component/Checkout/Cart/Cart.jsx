    ...
    return (
        <div className="grid lg:grid-cols-3 gap-8 p-6 md:mt-16">
            <div className="left lg:col-span-2 md:pe-8 bg-white overflow-x-auto h-[80vh]" id="style-1">
                ...
                <div className="rounded-lg border border-gray-200 p-4 lg:m-8 grid grid-cols-12 mb-8 max-lg:max-w-lg max-lg:mx-auto gap-y-4 ">
                    ...
                    <div className="col-span-12 lg:col-span-10 detail w-full lg:pl-3">
                        <div className="flex items-center justify-between w-full mb-4">
                            <h5 className="font-manrope font-bold text-xl leading-9 text-gray-900">Round white portable
                                speaker</h5>
                        ...
                        <div className="flex justify-between items-center">
                            ...
                            <div className="flex flex-col md:flex-row">
                                <span className="text-gray-600 ms-4 font-manrope font-bold text-xl leading-9 text-right">{formatIndianCurrency(220000)}</span></div>
                        </div>
                    </div>
                </div>
            ...
            <div className="border rounded-md h-fit p-6">
